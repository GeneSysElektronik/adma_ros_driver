...
def generate_launch_description():
        ...
        # xml_file_path = PathJoinSubstitution([FindPackageShare('adma_tools_py'), 'config', 'ADMA_UDP-DataStream_ADMAnet_v3.3.5_v35.2.0.1.xml'])
        # msg_file_output_path = PathJoinSubstitution([FindPackageShare('adma_ros_driver_msgs'), 'msg', 'ADMANet335.msg'])
