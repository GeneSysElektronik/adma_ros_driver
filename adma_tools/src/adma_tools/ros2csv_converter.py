...
class Ros2CSVConverter():
    ...
    def __init__(self):
        rospy.init_node('ros2csvConverter', anonymous=True)
        
        self.filename = "recorded_data.csv"
        self.sub_adma_data_scaled = message_filters.Subscriber("/adma/data_scaled", AdmaDataScaled)
        self.sub_adma_error_warning = message_filters.Subscriber("/adma/status", AdmaStatus)
