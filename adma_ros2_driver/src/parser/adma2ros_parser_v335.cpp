  ...
  adma_ros_driver_msgs::msg::AdmaDataScaled & ros_msg, AdmaDataV335 & adma_data)
{
  ...
  // ss_hv << int(static_header.headerversion[3]) << int(static_header.headerversion[2])
  //    << int(static_header.headerversion[1]) << int(static_header.headerversion[0]);
  // ros_msg.header_version = ss_hv.str();
  // ros_msg.format_id = static_header.formatid;
  // //TODO: this value is parsed wrong?!
  // // std::stringstream ss_fv;
  // // ss_fv << int(static_header.formatversion[3]) << int(static_header.formatversion[2])
  // //    << int(static_header.formatversion[1]) << int(static_header.formatversion[0]);
  // // ros_msg.format_version = ss_fv.str();
