...
public:
  ...
  void mapStatusBytes(adma_ros_driver_msgs::msg::ByteStatus & ros_msg_byte_status, AdmaDataV334 & adma_data);
  void mapStatusBitfields(adma_ros_driver_msgs::msg::Status & ros_msg_status, AdmaDataV334 & adma_data);
  ...
  void mapErrorWarningBytes(adma_ros_driver_msgs::msg::ByteErrorWarning & ros_msg_byte_error_warning, AdmaDataV334 & adma_data);
  void mapErrorWarningBitfields(adma_ros_driver_msgs::msg::ErrorWarning & ros_msg_error_warning, AdmaDataV334 & adma_data);
  ...
  void mapUnscaledData(adma_ros_driver_msgs::msg::AdmaDataScaled & ros_msg, AdmaDataV334 & adma_data);
