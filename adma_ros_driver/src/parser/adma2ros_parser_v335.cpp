...
void ADMA2ROSParserV335::mapAdmaMessageToROS(adma_ros_driver_msgs::AdmaDataScaled& rosMsg, AdmaDataV335& admaData)
{
...
void ADMA2ROSParserV335::mapStatusToROS(adma_ros_driver_msgs::AdmaStatus& rosMsg, AdmaDataV335& admaData)
{
...
void ADMA2ROSParserV335::mapAdmaHeader(adma_ros_driver_msgs::AdmaDataScaled& rosMsg, AdmaDataV335& admaData)
{
...
void ADMA2ROSParserV335::mapStatusBytes(adma_ros_driver_msgs::ByteStatus& rosMsgByteStatus, AdmaDataV335& admaData)
{
...
void ADMA2ROSParserV335::mapStatusBitfields(adma_ros_driver_msgs::Status& rosMsgStatus, AdmaDataV335& admaData)
{
        // status_byte_0
...
void ADMA2ROSParserV335::mapErrorWarningBytes(adma_ros_driver_msgs::ByteErrorWarning& rosMsgByteErrorWarning, AdmaDataV335& admaData)
{
...
void ADMA2ROSParserV335::mapErrorWarningBitfields(adma_ros_driver_msgs::ErrorWarning& rosMsgErrorWarning, AdmaDataV335& admaData)
{
...
void ADMA2ROSParserV335::mapUnscaledData(adma_ros_driver_msgs::AdmaDataScaled& rosMsg, AdmaDataV335& admaData)
{
        ...
        rosMsg.gnss_sats_single_freq = admaData.gnsssatssinglefreq;
        rosMsg.gnss_sats_multi_freq = admaData.gnsssatsmultifreq;
        rosMsg.gnss_log_delay = admaData.gnsslogdelay;
        std::stringstream ss;
        ss <<  admaData.gnssbasenr;
        rosMsg.gnss_base_nr = ss.str();
        rosMsg.gnss_sats_dualant_multi_freq = admaData.gnsssatsdualantmultifreq;
...
void ADMA2ROSParserV335::mapScaledData(adma_ros_driver_msgs::AdmaDataScaled& rosMsg, AdmaDataV335& admaData)
{
        ...
        rosMsg.gnss_stddev_cog = getScaledValue(admaData.gnssstddevcog, 0.01);
        ...
        rosMsg.ins_yaw_rel = getScaledValue(admaData.insyawrel, 0.01);
...
void ADMA2ROSParserV335::mapPOI(adma_ros_driver_msgs::AdmaDataScaled& rosMsg, AdmaDataV335& admaData)
{
